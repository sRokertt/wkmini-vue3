...
<template>
  <header class="grid items-center gap-10 md:grid-cols-[1fr_auto_1fr]">
    ...
    <nav class="hidden items-center justify-center gap-6 text-xs font-medium uppercase tracking-[0.18em] text-slate-500 md:flex">
      <router-link
